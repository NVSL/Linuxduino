...
// --- This definitions were added..
// Alpha, mips, sparc and powerpc use _IOC_SIZEBITS = 13
#if defined(__alpha__) || defined(__mips__) || defined(__sparc__) || defined(__powerpc__)
	# define _IOC_SIZEBITS 13
#endif
// Any other architecture use _IOC_SIZEBITS = 14
