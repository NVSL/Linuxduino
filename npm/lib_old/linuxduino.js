...
function integrateWasmJS(Module) {
  ...
  if (typeof window === 'object') {
    ...
    var wasmBinaryFile = Module['wasmBinaryFile'] || 'linuxduino.wasm';
  } else {
    // If running Node
    var wasmBinaryFile = Module['wasmBinaryFile'] || (__dirname+'/linuxduino.wasm');
  }
...
var ASM_CONSTS = [function() { if (typeof FS.mkdir === "function") { FS.mkdir('/sys'); FS.mount(NODEFS, { root: '/sys' }, '/sys'); FS.mkdir('/devices'); FS.mount(NODEFS, { root: '/dev' }, '/devices'); } }];
...
// {{PRE_LIBRARY}}
  ...
  var NODEFS={isWindows:false,staticInit:function () {
        ...
        if (!FS.isDir(mode) && !FS.isFile(mode) && !FS.isLink(mode) &&
          !FS.isChrdev(mode) && !FS.isBlkdev(mode)) {
          console.log("createNode error");
          throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
        }
        ...
        if (flags in NODEFS.flagsToPermissionStringMap) {
          ...
          try {
            if (FS.isFile(stream.node.mode) || FS.isChrdev(stream.node.mode) || FS.isBlkdev(stream.node.mode)) {
          ...
          try {
            if ( (FS.isFile(stream.node.mode) || FS.isChrdev(stream.node.mode) 
              || FS.isBlkdev(stream.node.mode)) && stream.nfd) {
          ...
          try {
            ...
            try {
              if (e.code === 'ESPIPE') {
                // Probably trying to read a device driver, remove position
          ...
          try {
            ...
            try {
              if (e.code === 'ESPIPE') {
                // Probably trying to write to a device driver, remove position
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_viiiii": nullFunc_viiiii, "nullFunc_vi": nullFunc_vi, "nullFunc_vii": nullFunc_vii, "nullFunc_iiiiiii": nullFunc_iiiiiii, "nullFunc_diddd": nullFunc_diddd, "nullFunc_ii": nullFunc_ii, "nullFunc_iiiiii": nullFunc_iiiiii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_viiiiii": nullFunc_viiiiii, "nullFunc_ddd": nullFunc_ddd, "nullFunc_dd": nullFunc_dd, "nullFunc_dddd": nullFunc_dddd, "nullFunc_fi": nullFunc_fi, "nullFunc_iii": nullFunc_iii, "nullFunc_didd": nullFunc_didd, "nullFunc_fii": nullFunc_fii, "nullFunc_did": nullFunc_did, "nullFunc_iiiii": nullFunc_iiiii, "nullFunc_i": nullFunc_i, "nullFunc_viii": nullFunc_viii, "nullFunc_v": nullFunc_v, "nullFunc_viiii": nullFunc_viiii, "invoke_viiiii": invoke_viiiii, "invoke_vi": invoke_vi, "invoke_vii": invoke_vii, "invoke_iiiiiii": invoke_iiiiiii, "invoke_diddd": invoke_diddd, "invoke_ii": invoke_ii, "invoke_iiiiii": invoke_iiiiii, "invoke_iiii": invoke_iiii, "invoke_viiiiii": invoke_viiiiii, "invoke_ddd": invoke_ddd, "invoke_dd": invoke_dd, "invoke_dddd": invoke_dddd, "invoke_fi": invoke_fi, "invoke_iii": invoke_iii, "invoke_didd": invoke_didd, "invoke_fii": invoke_fii, "invoke_did": invoke_did, "invoke_iiiii": invoke_iiiii, "invoke_i": invoke_i, "invoke_viii": invoke_viii, "invoke_v": invoke_v, "invoke_viiii": invoke_viiii, "___syscall221": ___syscall221, "floatReadValueFromPointer": floatReadValueFromPointer, "simpleReadValueFromPointer": simpleReadValueFromPointer, "throwInternalError": throwInternalError, "get_first_emval": get_first_emval, "getLiveInheritedInstances": getLiveInheritedInstances, "__ZSt18uncaught_exceptionv": __ZSt18uncaught_exceptionv, "ClassHandle": ClassHandle, "getShiftFromSize": getShiftFromSize, "_clock_gettime": _clock_gettime, "_emscripten_memcpy_big": _emscripten_memcpy_big, "runDestructor": runDestructor, "throwInstanceAlreadyDeleted": throwInstanceAlreadyDeleted, "__embind_register_std_string": __embind_register_std_string, "init_RegisteredPointer": init_RegisteredPointer, "ClassHandle_isAliasOf": ClassHandle_isAliasOf, "flushPendingDeletes": flushPendingDeletes, "makeClassHandle": makeClassHandle, "whenDependentTypesAreResolved": whenDependentTypesAreResolved, "__embind_register_class_constructor": __embind_register_class_constructor, "_pthread_cancel": _pthread_cancel, "init_ClassHandle": init_ClassHandle, "__embind_register_constant": __embind_register_constant, "___syscall140": ___syscall140, "ClassHandle_clone": ClassHandle_clone, "___syscall145": ___syscall145, "___syscall146": ___syscall146, "_emscripten_get_now_is_monotonic": _emscripten_get_now_is_monotonic, "RegisteredClass": RegisteredClass, "createNamedFunction": createNamedFunction, "___cxa_free_exception": ___cxa_free_exception, "_node_ioctl": _node_ioctl, "___cxa_find_matching_catch": ___cxa_find_matching_catch, "embind_init_charCodes": embind_init_charCodes, "_emscripten_asm_const_i": _emscripten_asm_const_i, "___setErrNo": ___setErrNo, "__embind_register_bool": __embind_register_bool, "___resumeException": ___resumeException, "_nanosleep": _nanosleep, "__embind_register_emval": __embind_register_emval, "__emval_decref": __emval_decref, "init_embind": init_embind, "constNoSmartPtrRawPointerToWireType": constNoSmartPtrRawPointerToWireType, "heap32VectorToArray": heap32VectorToArray, "_emscripten_get_now": _emscripten_get_now, "ClassHandle_delete": ClassHandle_delete, "___syscall3": ___syscall3, "RegisteredPointer_destructor": RegisteredPointer_destructor, "___syscall6": ___syscall6, "___syscall5": ___syscall5, "___syscall4": ___syscall4, "new_": new_, "downcastPointer": downcastPointer, "_exit": _exit, "replacePublicSymbol": replacePublicSymbol, "__embind_register_class": __embind_register_class, "_llvm_pow_f64": _llvm_pow_f64, "ClassHandle_deleteLater": ClassHandle_deleteLater, "___syscall54": ___syscall54, "RegisteredPointer_deleteObject": RegisteredPointer_deleteObject, "ClassHandle_isDeleted": ClassHandle_isDeleted, "__embind_register_integer": __embind_register_integer, "___cxa_allocate_exception": ___cxa_allocate_exception, "___syscall192": ___syscall192, "_embind_repr": _embind_repr, "throwUnboundTypeError": throwUnboundTypeError, "craftInvokerFunction": craftInvokerFunction, "runDestructors": runDestructors, "makeLegalFunctionName": makeLegalFunctionName, "___syscall33": ___syscall33, "upcastPointer": upcastPointer, "init_emval": init_emval, "shallowCopyInternalPointer": shallowCopyInternalPointer, "nonConstNoSmartPtrRawPointerToWireType": nonConstNoSmartPtrRawPointerToWireType, "throwBindingError": throwBindingError, "getTypeName": getTypeName, "exposePublicSymbol": exposePublicSymbol, "RegisteredPointer_fromWireType": RegisteredPointer_fromWireType, "___lock": ___lock, "__embind_register_memory_view": __embind_register_memory_view, "getInheritedInstance": getInheritedInstance, "setDelayFunction": setDelayFunction, "___gxx_personality_v0": ___gxx_personality_v0, "extendError": extendError, "ensureOverloadTable": ensureOverloadTable, "__embind_register_void": __embind_register_void, "__embind_register_function": __embind_register_function, "RegisteredPointer_getPointee": RegisteredPointer_getPointee, "__emval_register": __emval_register, "___cxa_find_matching_catch_2": ___cxa_find_matching_catch_2, "__embind_register_class_function": __embind_register_class_function, "__exit": __exit, "RegisteredPointer": RegisteredPointer, "_usleep": _usleep, "readLatin1String": readLatin1String, "getBasestPointer": getBasestPointer, "getInheritedInstanceCount": getInheritedInstanceCount, "__embind_register_float": __embind_register_float, "integerReadValueFromPointer": integerReadValueFromPointer, "___unlock": ___unlock, "__embind_register_std_wstring": __embind_register_std_wstring, "_pthread_create": _pthread_create, "genericPointerToWireType": genericPointerToWireType, "registerType": registerType, "___cxa_throw": ___cxa_throw, "count_emval_handles": count_emval_handles, "requireFunction": requireFunction, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
...
var real___GLOBAL__sub_I_Serial_cpp = asm["__GLOBAL__sub_I_Serial_cpp"]; asm["__GLOBAL__sub_I_Serial_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_Serial_cpp.apply(null, arguments);
};
...
var real___GLOBAL__sub_I_SPI_cpp = asm["__GLOBAL__sub_I_SPI_cpp"]; asm["__GLOBAL__sub_I_SPI_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var __GLOBAL__sub_I_Serial_cpp = Module["__GLOBAL__sub_I_Serial_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_Serial_cpp"].apply(null, arguments) };
...
var __GLOBAL__sub_I_SPI_cpp = Module["__GLOBAL__sub_I_SPI_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
